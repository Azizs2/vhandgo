            ...
            <div class="container">
                <div class="row">
                    <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12">
                        ...
                        <h1>
                            <strong>Daftarkan Bisnis Anda Dapatkan Modal Bisnis Dari Pemodal Setia Kami</strong>
                            <br>
                            <strong></strong>
                        </h1>
                        {{-- <p>Urun dana tidak perlu rumit, siapapun bisa bergabung.</p> --}}
                        <a href="{{url('register_bisnis')}}" class="main-button-slider">Daftarkan Bisnis</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-12 col-md-6 col-sm-6 col-12"
                            ...
                            <div class="features-small-item">
                                ...
                                <h5 class="features-title">
                                    <strong>
                                        Langkah Mudah Daftarkan Bisnis Anda
                                    </strong>
                                </h5>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 align-self-center mobile-top-fix">
                    ...
                    <div class="left-heading">
                        <h2 class="section-title">2. Input Data Bisnis Anda</h2>
                    </div>
                    <div class="left-text">
                        <p>Masukkan data bisnis Anda beserta gambar dan video profil perusahaan untuk menarik Pemodal.</p>
                    </div>
                    <div class="left-heading">
                        <h2 class="section-title">3. Tunggu Verifikasi</h2>
                    </div>
                    <div class="left-text">
                        <p>Tunggu verifikasi. Setelah verifikasi bisnis Anda masuk ke pra listing dan Pemodal akan melakukan vote untuk memilih bisnis yang akan listing selanjutnya.</p>
                    </div>
                    <div class="left-heading">
                        <h2 class="section-title">4. Listing di Vhandgo</h2>
                    </div>
                    <div class="left-text">
                        <p>Bisnis dengan vote yang banyak dan memenuhi syarat listing dan Vhandgo akan melakukan pendanaan. Pemodal bisa investasi di perusahaan Anda.</p>
                    </div>
                </div>
            </div>
            <div class="row">
